...
![Subheaders sticking to top of screen with position: sticky](https://www.codedex.io/images/css/exercise-24-sticky-position-1.gif)
...
![Subheaders sticking to top of screen with position: sticky](https://www.codedex.io/images/css/exercise-24-sticky-position-2.gif)

We placed the `ul` element in front of the section `h2` headers with the `z-index` property. Pretty nifty!
