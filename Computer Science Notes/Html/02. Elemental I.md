...
[!IMPORTANT]   **Note:** There can only be one `<body>` element in a file.
...
> 
> Please refer to the [installation guide](./INSTALL.md) before proceeding

> [!TIP]
> For best results, use a virtual environment
> 
> See the [quick start](./QUICKSTART.md) guide for examples
