...
> [!NOTE]
> For the rest of this chapter, the `action` and `method`attributes will not be featured in the examples. Not to worry, though! The forms will still render just fine. 😀
