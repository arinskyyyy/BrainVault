...
![Diagram of the Document Object Model (DOM)](https://www.codedex.io/images/javascript/exercise-40-dom-diagram.png)
...
_Everything_ found in that HTML file would be logged to the console! 🤯

![DOM Demo](https://www.codedex.io/images/javascript/exercise-40-dom-demo.gif)
