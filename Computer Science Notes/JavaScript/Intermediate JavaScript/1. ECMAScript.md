...
In 2015, a major shift in how we write modern JavaScript occurred with the release of [ECMAScript 2015 (or ES6)](https://en.wikipedia.org/wiki/ECMAScript). This led to features such as:
...
> [!NOTE]
> If you're using `let` and `const` for variables, you're already writing in ES6! 😀
