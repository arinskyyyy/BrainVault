...
Oh wait... the output is an _array of two arrays_. How can we combine them into a single array? We can use a handy tool called a spread operator!
...
- Help with de-structuring arrays and objects.
